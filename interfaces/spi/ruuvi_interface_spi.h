...
typedef struct{
  ...
  ruuvi_interface_spi_frequency_t frequency; //!< Frequency of SPI Bus, see @ref ruuvi_interface_spi_frequency_t
  ruuvi_interface_spi_mode_t mode;           //!< Mode of SPI Bus, see @ref ruuvi_interface_spi_mode_t
 ...
 **/
 ruuvi_driver_status_t ruuvi_interface_spi_init(const ruuvi_interface_spi_init_config_t* const config);
 ...
 **/
ruuvi_driver_status_t ruuvi_interface_spi_xfer_blocking(const uint8_t* const p_tx, const size_t tx_len, uint8_t* const p_rx, const size_t rx_len);
/* @} */
#endif