...
int32_t ruuvi_interface_spi_lis2dh12_write(void* dev_ptr, uint8_t reg_addr, uint8_t *reg_data, uint16_t len)
{
...
int32_t ruuvi_interface_spi_lis2dh12_read (void* dev_ptr, uint8_t reg_addr, uint8_t *reg_data, uint16_t len)
{
  ruuvi_driver_status_t err_code = RUUVI_DRIVER_SUCCESS;
  uint8_t dev_id = *((uint8_t*)dev_ptr);
