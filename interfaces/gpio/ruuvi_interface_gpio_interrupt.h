 ...
 */
ruuvi_driver_status_t ruuvi_interface_gpio_interrupt_init(const ruuvi_interface_gpio_interrupt_fp_t* const interrupt_table, const uint8_t max_interrupts);
