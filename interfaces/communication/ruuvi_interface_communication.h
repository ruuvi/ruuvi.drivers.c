...
struct ruuvi_interface_communication_t
{
  ...
  ruuvi_interface_communication_init_fp_t        init;    //!< Initialize and populate channel api control
  ruuvi_interface_communication_init_fp_t        uninit;  //!< Uninitialize and depopulate channel api control
  ruuvi_interface_communication_evt_handler_fp_t on_evt;  //!< Callback to application-level event handler, must be set in application.
};
